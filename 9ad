...
local fuelModel = workspace.Items["Fuel Canister"].Cap
local bamdage = workspace.Items.Bandage.Tie
...
-- Custom button: Tre Em
local customCollect = Instance.new("TextButton")
customCollect.Size = UDim2.new(0, 300, 0, 36)
customCollect.BackgroundColor3 = Color3.fromRGB(150, 100, 50)
customCollect.Text = "Tre Em"
customCollect.TextColor3 = Color3.fromRGB(255,255,255)
customCollect.Font = Enum.Font.SourceSansBold
customCollect.TextSize = 16
customCollect.Parent = Content
customCollect.MouseButton1Click:Connect(function()
	hrp.CFrame = workspace.Characters["Lost Child"].Head.CFrame + Vector3.new(5,5,5)
    wait(5)
	hrp.CFrame = workspace.Characters["Lost Child2"].Head.CFrame + Vector3.new(5,5,5)
    wait(5)
	hrp.CFrame = workspace.Characters["Lost Child3"].Head.CFrame + Vector3.new(5,5,5)
    wait(5)
	hrp.CFrame = workspace.Characters["Lost Child4"].Head.CFrame + Vector3.new(5,5,5)
end)


-- Custom button: thungxang
local customCollect = Instance.new("TextButton")
customCollect.Size = UDim2.new(0, 300, 0, 36)
customCollect.BackgroundColor3 = Color3.fromRGB(150, 100, 50)
customCollect.Text = "Xang"
customCollect.TextColor3 = Color3.fromRGB(255,255,255)
customCollect.Font = Enum.Font.SourceSansBold
customCollect.TextSize = 16
customCollect.Parent = Content
customCollect.MouseButton1Click:Connect(function()
if true then hrp.CFrame = fuelModel.CFrame + Vector3.new(0, 5, 0) end
end)

-- Custom button: Bandage
local customCollect = Instance.new("TextButton")
customCollect.Size = UDim2.new(0, 300, 0, 36)
customCollect.BackgroundColor3 = Color3.fromRGB(150, 100, 50)
customCollect.Text = "Bandage"
customCollect.TextColor3 = Color3.fromRGB(255,255,255)
customCollect.Font = Enum.Font.SourceSansBold
customCollect.TextSize = 16
customCollect.Parent = Content
customCollect.MouseButton1Click:Connect(function()
if true then hrp.CFrame = bamdage.CFrame + Vector3.new(5, 5, 0) end
end)
